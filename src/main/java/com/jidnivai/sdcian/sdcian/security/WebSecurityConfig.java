        ...
        http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(auth -> auth
                    ...
                    .requestMatchers("/api/intro/**").permitAll()
                        ...
                        .requestMatchers("/api/homeImages/**").permitAll()
                        ...
                        .requestMatchers("/bkashpayment/**").permitAll()
                        .requestMatchers("/api/uploads/sdcianjersey/**").permitAll()
                        .requestMatchers("/bkashindex.html").permitAll()
                        .requestMatchers("/error").permitAll()
                        .requestMatchers("/").permitAll()
                        .requestMatchers("/favicon.ico").permitAll()
                        .requestMatchers(HttpMethod.OPTIONS, "/api/**").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/jersey/**").permitAll()
